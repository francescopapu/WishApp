...
<html style="font-size: 16px;">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ddeb"><div class="u-clearfix u-sheet u-sheet-1"></div></header>
    ...
    <section class="u-clearfix u-section-2" id="sec-91ba">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-custom-font u-text u-text-body-color u-text-1">${id_gruppo}.</h1>
        ...
        <div class="u-container-style u-expanded-width u-group u-palette-5-light-2 u-radius-30 u-shape-round u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <c:forEach var="nome_partecipante" items="${requestScope.nomi_partecipanti}">
              <div class="u-container-style u-expanded-width u-group u-radius-30 u-shape-round u-white u-group-2">
                <div class="u-container-layout u-container-layout-2">
                  <p class="u-custom-font u-text u-text-3">
                    <span style="font-size: 1.5rem; font-weight: 400;" class="u-text-palette-5-dark-3">${nome_partecipante}</span>
                  </p>
                  <form action="${pageContext.servletContext.contextPath}/logged_in/gruppo/" method="post">
                    <button type="submit" name="id_partecipante" value="${nome_partecipante}" class="u-border-2 u-border-hover-white u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-50 u-text-hover-white u-text-palette-2-base u-btn-4">RIMUOVI</button>
                  </form>
                </div>
              </div>
            ...
            <c:forEach var="nome_lista" items="${requestScope.nomi_liste}">
              <div class="u-container-style u-expanded-width u-group u-radius-30 u-shape-round u-white u-group-4">
                <div class="u-container-layout u-container-layout-4">
                  ...
                  <form action="${pageContext.servletContext.contextPath}/logged_in/gruppo/" method="post">
                    <button type="submit" name="id_lista" value="${nome_lista}" class="u-border-2 u-border-hover-white u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-50 u-text-hover-white u-text-palette-2-base u-btn-5">RIMUOVI</button>
                  </form>
                  <p class="u-custom-font u-text u-text-6">Utente proprietario </p>
                </div>
              </div>
