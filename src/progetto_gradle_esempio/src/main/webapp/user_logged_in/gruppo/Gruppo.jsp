...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Gruppo</title>
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/user_logged_in/gruppo/nicepage.css" media="screen">
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/user_logged_in/gruppo/Gruppo.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ddeb"><div class="u-clearfix u-sheet u-sheet-1"></div></header>
    ...
    <section class="u-clearfix u-section-2" id="sec-91ba">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <form action="${pageContext.servletContext.contextPath}/user_logged_in/gruppo/" method="post">
