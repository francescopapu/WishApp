...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Wishapp, Come funziona?">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ddeb"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <a href="<%=request.getContextPath()%>/login" class="u-border-2 u-border-hover-white u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-50 u-text-hover-white u-text-palette-2-base u-btn-1">ACCEDI / REGISTRATI</a>
      </div></header>
    <section class="u-align-left u-clearfix u-section-1" id="sec-9885">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-sheet-1">
        ...
        <div class="u-align-left u-image u-image-circle u-image-1" data-image-width="1400" data-image-height="933"></div>
        <div class="u-container-style u-expanded-width-xs u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h2 class="u-align-left u-custom-font u-text u-text-palette-2-base u-text-1">Wishapp</h2>
            <h3 class="u-custom-font u-text u-text-font u-text-grey-50 u-text-2"> CONDIVIDI I TUOI DESIDERI.</h3>
          </div>
        </div>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-section-2" id="carousel_e567">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h1 class="u-custom-font u-text u-text-body-alt-color u-text-1">Come funziona?</h1>
        <p class="u-text u-text-body-alt-color u-text-2">Tante funzionalità a portata di click.&nbsp;</p>
        <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-list u-repeater u-list-1">
          <div class="u-align-left u-container-style u-list-item u-palette-5-light-2 u-repeater-item u-list-item-1">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              ...
              <h5 class="u-text u-text-3">Salva tutti gli oggetti che desideri.</h5>
              <p class="u-text u-text-4">Registrati subito e in pochi click potrai creare la tua prima lista dei desideri!<br>
                <br>Visualizza le tue liste, aggiungi e rimuovi oggetti, cambiane il nome e, se non servono più, eliminarle.<br>
              </p>
            </div>
          </div>
          <div class="u-align-left u-container-style u-list-item u-palette-5-light-2 u-repeater-item u-list-item-2">
            <div class="u-container-layout u-similar-container u-container-layout-3">
              <div class="u-align-left u-container-style u-group u-palette-2-base u-radius-50 u-shape-round u-group-2">
                <div class="u-container-layout u-container-layout-4"></div>
              </div>
              <h5 class="u-text u-text-5">Condividi le tue passioni.<br>
              </h5>
              <p class="u-text u-text-6">Ti abbiamo convinto? Porta su WishApp i tuoi amici!<br>
                <br>Crea gruppi che riflettano le tue cerchie di amici (colleghi universitari, amici del calcetto...) e condividi con ogni gruppo le liste dei desideri con gli oggetti che vi appassionano.<br>
              </p>
            </div>
          </div>
        </div>
